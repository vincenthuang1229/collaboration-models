;;; Model3 :Global Model
;;; The process of collaboration is infected by four parameters: p, q, experience bound and global experience distribution;
...
to output
  ...
  if ticks = 5000  [ export-world "Trial3_5k.csv" ]
  if ticks = 10000 [ export-world "Trial3_10k.csv" ]
  if ticks = 15000 [ export-world "Trial3_15k.csv" ]
  if ticks = 20000 [ export-world "Trial3_20k.csv" ]
  if ticks = 25000 [ export-world "Trial3_25k.csv" ]
  if ticks = 30000 [ export-world "Trial3_30k.csv"
                     export-output "Output3.txt" ]
end
