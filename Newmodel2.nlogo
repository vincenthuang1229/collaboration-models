;;; Model2 :Experience Bounds Model
;;; The process of collaboration is infected by two parameters: p and q and limited by experience bound;
...
turtles-own
  [
    ...
    xp           ;; the value of players' experince level
...
to output
  ...
  if ticks = 5000  [ export-world "Trial2_5k.csv" ]
  if ticks = 10000 [ export-world "Trial2_10k.csv"]
  if ticks = 15000 [ export-world "Trial2_15k.csv" ]
  if ticks = 20000 [ export-world "Trial2_20k.csv" ]
  if ticks = 25000 [ export-world "Trial2_25k.csv" ]
  if ticks = 30000 [ export-world "Trial2_30k.csv"
                     export-output "Output2.txt" ]
end
...
to collaborate
  ...
  ;; two players will not collaborate with each other if their experience gap is beyond experience bound: 10
